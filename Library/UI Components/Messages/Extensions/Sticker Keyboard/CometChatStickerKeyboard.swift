...
class CometChatStickerKeyboard: UIViewController {
    ...
    private func setupCollectionView() {
        ...
        let CometChatStickerKeyboardItem = UINib(nibName: "CometChatStickerKeyboardItem", bundle: UIKitSettings.bundle)
    ...
    @IBAction func didCloseButtonPressed(_ sender: Any) {
        CometChatStickerKeyboard.stickerDelegate?.didClosePressed()
