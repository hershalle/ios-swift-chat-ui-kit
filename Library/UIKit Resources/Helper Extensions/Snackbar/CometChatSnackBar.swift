...
@objc  enum CometChatSnackbarDuration: Int {
    case short = 1
    case middle = 3
    case long = 5
...
@objc  enum CometChatSnackbarAnimationType: Int {
    case fadeInFadeOut
...
extension UIColor {
  @objc class  dynamic var CometChatDefaultText : UIColor {
    if #available(iOS 13, *) {
  ...
  @objc class  dynamic var CometChatDefaultBackground : UIColor {
    if #available(iOS 13, *) {
  ...
  @objc class  dynamic var CometChatDefaultShadow : UIColor {
    if #available(iOS 13, *) {
      // Meaning It's black in lighter mode and white in dark mode.
 ...
 class CometChatSnackbar: UIView {
    // MARK: - Class property.
    
    /// Snackbar default frame
     static var snackbarDefaultFrame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 80)
    
    /// Snackbar min height
     static var snackbarMinHeight: CGFloat = 60
    
    // MARK: - Typealias.
    
    /// Action callback closure definition.
     typealias CometChatActionBlock = (_ snackbar:CometChatSnackbar) -> Void
    
    /// Dismiss callback closure definition.
     typealias CometChatDismissBlock = (_ snackbar:CometChatSnackbar) -> Void
    
    /// Swipe gesture callback closure
     typealias CometChatSwipeBlock = (_ snackbar: CometChatSnackbar, _ direction: UISwipeGestureRecognizer.Direction) -> Void
    
    // MARK: -  property.
    
    /// Tap callback
    @objc  dynamic var onTapBlock: CometChatActionBlock?
    
    /// Swipe callback
    @objc  dynamic var onSwipeBlock: CometChatSwipeBlock?
    
    /// A property to make the snackbar auto dismiss on Swipe Gesture
    @objc  dynamic var shouldDismissOnSwipe: Bool = false
    
    /// a property to enable left and right margin when using customContentView
    @objc  dynamic var shouldActivateLeftAndRightMarginOnCustomContentView: Bool = false
    
    /// Action callback.
    @objc  dynamic var actionBlock: CometChatActionBlock? = nil
    
    /// Second action block
    @objc  dynamic var secondActionBlock: CometChatActionBlock? = nil
    
    /// Dismiss callback.
    @objc  dynamic var dismissBlock: CometChatDismissBlock? = nil
    
    /// Snackbar display duration. Default is Short - 1 second.
    @objc  dynamic var duration: CometChatSnackbarDuration = CometChatSnackbarDuration.short
    
    /// Snackbar animation type. Default is SlideFromBottomBackToBottom.
    @objc  dynamic var animationType: CometChatSnackbarAnimationType = CometChatSnackbarAnimationType.slideFromBottomToTop
    
    /// Show and hide animation duration. Default is 0.3
    @objc  dynamic var animationDuration: TimeInterval = 0.3
    
    /// Corner radius: [0, height / 2]. Default is 4
    @objc  dynamic var cornerRadius: CGFloat = 5 {
        didSet {
            if cornerRadius < 0 {
                cornerRadius = 0
            }
    ...
    @objc  dynamic var borderColor: UIColor? = .clear {
        didSet {
    ...
    @objc  dynamic var borderWidth: CGFloat = 1 {
        didSet {
    ...
    @objc  dynamic var leftMargin: CGFloat = 5 {
        didSet {
    ...
    @objc  dynamic var rightMargin: CGFloat = 5 {
        didSet {
    ...
    @objc  dynamic var bottomMargin: CGFloat = 5 {
        didSet {
    ...
    @objc  dynamic var topMargin: CGFloat = 5 {
        didSet {
    ...
    @objc  dynamic var contentInset: UIEdgeInsets = UIEdgeInsets.init(top: 0, left: 4, bottom: 0, right: 4) {
        didSet {
    ...
    @objc  dynamic var messageTextColor: UIColor = UIColor.CometChatDefaultText {
        didSet {
    ...
    @objc  dynamic var messageTextFont: UIFont = UIFont.systemFont(ofSize: 17, weight: .regular) {
        didSet {
    ...
    @objc  dynamic var messageTextAlign: NSTextAlignment = .center {
        didSet {
    ...
    /// Action button title.
    @objc  dynamic var actionText: String = "" {
        didSet {
    ...
    /// Action button image.
    @objc  dynamic var actionIcon: UIImage? = nil {
        didSet {
    ...
    @objc  dynamic var secondActionText: String = "" {
        didSet {
    ...
    @objc  dynamic var actionTextColor: UIColor = UIColor.CometChatDefaultText {
        didSet {
    ...
    @objc  dynamic var secondActionTextColor: UIColor = UIColor.CometChatDefaultText {
        didSet {
    ...
    @objc  dynamic var actionTextFont: UIFont = UIFont.systemFont(ofSize: 17, weight: .regular) {
        didSet {
    ...
    @objc  dynamic var secondActionTextFont: UIFont = UIFont.systemFont(ofSize: 17, weight: .regular) {
        didSet {
    ...
    @objc  dynamic var actionMaxWidth: CGFloat = 64 {
        didSet {
    ...
    @objc  dynamic var actionTextNumberOfLines: Int = 1 {
        didSet {
    ...
    /// Icon image
    @objc  dynamic var icon: UIImage? = nil {
        didSet {
    ...
    /// Icon image content
    @objc  dynamic var iconContentMode: UIView.ContentMode = .center {
        didSet {
    ...
    @objc  dynamic var iconBackgroundColor: UIColor? = .clear {
        didSet {
    ...
    /// Icon tint color
    @objc  dynamic var iconTintColor: UIColor! = .clear {
        didSet {
    ...
    /// Icon width
    @objc  dynamic var iconImageViewWidth: CGFloat = 32 {
        didSet {
    ...
    @objc  dynamic var containerView: UIView?
    
    /// Custom content view
    @objc  dynamic var customContentView: UIView?
    
    /// SeparateView background color
    @objc  dynamic var separateViewBackgroundColor: UIColor = UIColor.systemGray {
        didSet {
    ...
    @objc  dynamic var activityIndicatorViewStyle: UIActivityIndicatorView.Style {
        get {
    ...
    @objc  dynamic var activityIndicatorViewColor: UIColor {
        get {
    ...
    @objc  dynamic var animationSpringWithDamping: CGFloat = 0.7
    
    /// Animation initialSpringVelocity
    @objc  dynamic var animationInitialSpringVelocity: CGFloat = 5
    ...
    /**
     ...
     - returns: CometChatSnackbar instance
     */
    @objc  init(message: String, duration: CometChatSnackbarDuration) {
        super.init(frame: CometChatSnackbar.snackbarDefaultFrame)
    ...
    /**
     ...
     - returns: CometChatSnackbar instance
     */
     init(customContentView: UIView, duration: CometChatSnackbarDuration) {
        super.init(frame: CometChatSnackbar.snackbarDefaultFrame)
        self.duration = duration
    ...
    /**
     ...
     - returns: CometChatSnackbar instance
     */
     init(message: String, duration: CometChatSnackbarDuration, actionText: String, actionBlock: @escaping CometChatActionBlock) {
        super.init(frame: CometChatSnackbar.snackbarDefaultFrame)
        self.duration = duration
        self.message = message
    ...
    /**
     ...
     - returns: CometChatSnackbar instance
     */
     init(message: String, duration: CometChatSnackbarDuration, actionText: String, messageFont: UIFont, actionTextFont: UIFont, actionBlock: @escaping CometChatActionBlock) {
        super.init(frame: CometChatSnackbar.snackbarDefaultFrame)
        self.duration = duration
        self.message = message
        self.actionText = actionText
