...
class Presenter: NSObject {
    ...
    init(config: CometChatSnackBoard.Config, view: UIView, delegate: PresenterDelegate) {
        self.config = config
        self.view = view
    ...
    var id: String
    var config: CometChatSnackBoard.Config
    ...
    private static func animator(forPresentationStyle style: CometChatSnackBoard.PresentationStyle, delegate: AnimationDelegate) -> Animator {
        switch style {
        case .top:
    ...
    private func getPresentationContext() throws -> PresentationContext {
        ...
        case .automatic:
            #if CometChatSnackBoard_APP_EXTENSIONS
            throw CometChatSnackBoardError.noRootViewController
            #else
